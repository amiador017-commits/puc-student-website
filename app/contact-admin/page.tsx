  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl mx-auto">
      <header className="mb-8">
        <p className="page-breadcrumb">Account / Contact Admin</p>
        <h1 className="page-title-lg">Contact Admin</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
        <div className="shadow-clay-raised rounded-clay-xl p-6 flex flex-col" style={{ background: "#121216" }}>
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-clay bg-neon/10 flex items-center justify-center border border-neon/20">
          ...
          <div className="space-y-4 flex-1">
            {admins.map((admin) => (
              <div
                key={admin.id}
                className="p-4 rounded-clay-lg flex flex-col gap-2 transition-all hover:bg-white/[0.01] shadow-clay-inset"
              ...
              >
                <div className="flex justify-between items-start w-full">
                  ...
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded-clay-sm bg-neon/10 text-neon border border-neon/20 font-space-mono tracking-wider uppercase">
                    Admin
                  </span>
                </div>
                <a
                  ...
                  className="clay-btn inline-flex items-center gap-2 text-xs font-semibold px-4 py-2 rounded-clay text-space-950 transition-all duration-200 hover:opacity-90 w-fit"
        ...
        <div className="shadow-clay-raised rounded-clay-xl p-6 flex flex-col" style={{ background: "#121216" }}>
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-clay bg-blue-500/10 flex items-center justify-center border border-blue-500/20">
          ...
          <div className="grid grid-cols-4 gap-1.5 mb-6">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((sem) => (
              <button
                ...
                className={`py-1.5 px-1 rounded-clay-sm text-center text-xs font-semibold font-space-mono transition-all duration-150 ${
          ...
          <div className="min-h-[160px] flex flex-col">
            {activeCR ? (
              <div className="p-4 rounded-clay-lg flex flex-col gap-2 transition-all shadow-clay-inset" style={{ background: "#0e0e11" }}>
                <div className="flex justify-between items-start w-full">
                  <div>
                    <h3 className="text-sm font-semibold text-white font-syne">{activeCR.name}</h3>
                    <p className="text-xs text-gray-500 mb-2">B.Sc. in CSE ( PUC )</p>
                  </div>
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded-clay-sm bg-blue-500/10 text-blue-400 border border-blue-500/20 font-space-mono tracking-wider whitespace-nowrap">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-xs font-semibold px-4 py-2 rounded-clay text-white transition-all duration-200 hover:opacity-90 w-fit"
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center p-6 rounded-clay-lg shadow-clay-inset" style={{ background: "#0e0e11" }}>
